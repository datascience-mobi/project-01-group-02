...
histogram, #pick one gene, #pick one of the 34 mutation lists, #look how often an entry is is in the mutation list, #sum it up to get the total count for each gene, #rename it nicely, #make a nice dataframe, #sort the data frame
```{r}
