...
The cell lines behave differently when the sme gene is knocked out. 

### <span style="color:orange">**2.2.1 Distribution of the expression values between the different cell lines**</span>
...
### <span style="color:orange">**2.2.1 Plotting how often a gene is mutated over all Cell**</span>
...
These 10 Genes will be our driver genes of which we want to identify interactions with other genes. 
```{r}
...
```
The clustering with two centers seems to be the best one. Our next step in the pca will be to see which of the genes drive the differentation of the celllines in this plot because they will be the most variable and thus  most interesting ones.

# <span style="color:orange">**3.23 PCA**</span>
...
# <span style="color:orange">**4. Multiple linear regression analysis**</span>
